...
const ManageSingleFoodDetails = ({RequestFood}) => {
  ...
  <div className="relative rounded-t-xl overflow-hidden">
    <img className="w-full h-full mx-auto top-0 left-0 object-cover group-hover:scale-105 transition-transform duration-500 ease-in-out rounded-t-xl" src={RequestFood?.requesterpic} alt="Image Description"/>
  </div>
  ...
  <div className="flex items-center">
    ...
    <h3 className="dark:text-white">
        <span className="text-lg font-bold mr-2">Requester Name:</span>
      {RequestFood?.resqester}
    </h3>
      <h3 className="">
        <span className="text-lg font-bold mr-2">Requester Email</span>
        {RequestFood?.email}
        </h3>
      <h3 className="">
        <span className="text-lg font-bold mr-2">Requester Email</span>
